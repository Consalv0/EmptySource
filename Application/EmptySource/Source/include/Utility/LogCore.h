...
namespace Debug {
    ...
    void Log(unsigned char Filter, WString Text, Arguments ... Args) {
        ...
        if ((Filter & LogDebug & LogFilter::Value)    != NoLog) LogText = L"\033[33;40m[WARNING]\033[33;49m ";
        ...
        if ((Filter & LogCritical & LogFilter::Value) != NoLog) LogText = L"\033[32;40m[DEBUG]\033[32;49m ";
