...
protected:
	...
	virtual void OnAttach() override {
		...
		NormalTexture->Load();
		TextureMng.LoadImageFromFile(L"FlowMapTexture", PF_RGB8,  FM_MinMagLinear,  SAM_Repeat, true, L"Resources/Textures/FlowMap.jpg");
		...
		TextureMng.LoadImageFromFile(L"Sponza/ColumnAAlbedoTexture",      PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_a_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnARoughnessTexture",   PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_a_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnANormalTexture",      PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_a_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnBAlbedoTexture",      PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_b_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnBRoughnessTexture",   PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_b_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnBNormalTexture",      PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_b_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnCAlbedoTexture",      PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_c_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnCNormalTexture",      PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_c_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ColumnCRoughnessTexture",   PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Column_c_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/BricksAAlbedoTexture",      PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Bricks_a_Albedo.tga");
		TextureMng.LoadImageFromFile(L"Sponza/BricksARoughnessTexture",   PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Bricks_a_Roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/BricksANormalTexture",      PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Bricks_a_Normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/CeilingAlbedoTexture",      PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Ceiling_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/CeilingRoughnessTexture",   PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Ceiling_Roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/CeilingNormalTexture",      PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Ceiling_Normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/FloorAlbedoTexture",        PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Floor_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/FloorRoughnessTexture",     PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Floor_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/FloorNormalTexture",        PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Floor_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/RoofAlbedoTexture",         PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Roof_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/RoofRoughnessTexture",      PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Roof_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/RoofNormalTexture",         PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Roof_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ArchAlbedoTexture",         PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Arch_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ArchRoughnessTexture",      PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Arch_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ArchNormalTexture",         PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Arch_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ThornAlbedoTexture",        PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Thorn_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ThornRoughnessTexture",     PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Thorn_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/ThornNormalTexture",        PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Sponza_Thorn_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseAlbedoTexture",         PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Vase_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseRoughnessTexture",      PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Vase_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseNormalTexture",         PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/Vase_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseRoundAlbedoTexture",    PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/VaseRound_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseRoundRoughnessTexture", PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/VaseRound_roughness.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseRoundNormalTexture",    PF_RGB8,  FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/VaseRound_normal.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseHangAlbedoTexture",     PF_RGBA8, FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/VaseHanging_diffuse.tga");
		TextureMng.LoadImageFromFile(L"Sponza/VaseHangRoughnessTexture",  PF_R8,    FM_MinMagLinear, SAM_Repeat, true, L"Resources/Textures/SponzaPBR/VaseHanging_roughness.tga");
